...
<body>
  <header>
    <div>
      <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="" height="30px">
    ...
    <nav>
      <ul>
        <?php foreach ($nav as $key => $value) { ?>
          ...
          <li class="<?= $value['active']==true?'active': '' ?>"><?= $value['link'] ?></li>
